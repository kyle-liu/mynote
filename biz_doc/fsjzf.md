...
业务场景 |  账户名称 | 账户属性 | 行为方向 |账户增减逻辑
----------- | ----------|------|----|----  
转账 | A的余额账户| C | C  | +20
转账 | 支付宝银存账户| D | D  | +20
话费充值 | A的余额账户| C | D  | -100
话费充值 | 话费充值商家的余额账户| C | C  | +100

**5.A使用支付宝花呗消费了100元**  
*记账角色:* 支付宝   
*账户及属性:*   
A的的花呗额度为负债账户，记作贷/C,虽然记为负债，但是属于表外账，不属于支付宝的负债，不符合“有借必有贷，借贷必相等”的规则，只是用登记薄的方式记账，会计科目中，也不会对表外账作试算平衡    
A的的花呗贷款账户为资产账户，记作借/D，代表支付宝应收款，是支付宝的资产  
A的余额账户为负债账户，记作贷/C  
商户余额账户为负债账户，记作贷/C    

*资金流向:*  
先从A的花呗账户转账100元到A的余额账户;  
再从A的余额账户转账100元到商户账户  
*推导结果：*

业务场景 | 账户名称 | 账户属性 | 行为方向 |账户增减逻辑
----------- | ----------|------|----|----  
花呗借款转余额 | A的花呗额度账户| C | D  | -100   
花呗借款转余额 | A的花呗贷款账户| D | D  | +100
花呗借款转余额 | A的余额账户| C | C  | +100
用户消费 | A的余额宝账户| C | D  | -100
用户消费 | 商户余额账户 | C | C  | +100 

**6.A从银行充值还款支付宝100到支付宝花呗**  
*记账角色:* 支付宝   
*账户及属性:*  
A的余额账户为负债账户,记作贷/C       
A的的花呗额度为负债账户，记作贷/C,同上为表外账  
A的的花呗贷款账户为资产账户，记作借/D，代表支付应收款，是支付宝的资产   
支付宝银存账户为资产账户，记作借/D  

*资金流向:*  
银行先把100元转账到支付宝机构在银行开设的账户;  
先是充值行为：A在支付宝的余额账户会增加100元；    
然后是还款行为:从A的支付宝余额账户转账100到A的支付宝花呗账户 
...
充值| A的余额账户  | C  | C | +100
花呗还款| A的余额账户  | C  | D | -100
花呗还款| A的花呗额度账户| C | C  | +100
花呗还款| A的花呗贷款账户| D | C  | -100 
